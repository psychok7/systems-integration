    ...
    <body>
        ...
        <section class="main">
            ...
            <section class="big-content left">
                <section id="auth">
                    <h2>Edit Profile</h2>
                    <form id="register-form" action="/Phasebook-war/EditController.do" method="post">
                        <input type="hidden" id="hidMethod" name="hidMethod" value="processRequest"/>
                        <fieldset>
                            ...
                            <div class="clear"></div>
                            <input type="submit" class="button" name="commit" value="Edit"/>	
                            <div class="clear"></div>
                        </fieldset>
                    </form>
                </section>
