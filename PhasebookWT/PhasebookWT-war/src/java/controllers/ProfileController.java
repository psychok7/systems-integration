...
import test.artefact.friends.FriendWS2_Service;
...
public class ProfileController extends AbstractController {
    ...
    public void addFriend(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, Exception {
        ...
        String addFriend =new FriendWS2_Service().getFriendWS2Port().addFriend(manager.convertXMLFileToString(WEBUSER_XML),Integer.toString(userProfile.getIduser()));        
